...
<header id="header">
    ...
    } else if (Yii::$app->user->identity && Yii::$app->user->identity->user_type == 3) {
        // specify what normal user can see
        $items[] = [
            'label' => 'View',
            'url' => ['/user/view', 'user_id' => Yii::$app->user->identity->user_id]
        ];
    } else {
...
<footer id="footer" class="mt-auto py-3 bg-light">
    <div class="container">
        <div class="row text-muted">
            <div class="col-md-6 text-center text-md-start">&copy; UMS <?= date('Y') ?></div>
        </div>
    </div>
</footer>
