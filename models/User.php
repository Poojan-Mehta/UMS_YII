...
class User extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['user_name', 'user_email', 'user_mobile_no', 'user_type', 'password'], 'required'],
            [['user_email'], 'email'],
            [['user_email'], 'unique'],
            [['user_status'], 'default', 'value' => 0],
            //[['otp'], 'integer'], // OTP should be an integer
            [['user_id', 'created_at', 'updated_at', 'otp'], 'safe'],
        ];
    }
    ...
    {
        return $this->user_id; // Adjust this if your primary key column is different
    }
